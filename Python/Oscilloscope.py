...
class Oscilloscope(tk.Frame):
	...
	def __init__(self, parent, *args, **kwargs):
		...
		self.nanos_per_sample_in_ets_mode = 100
	...
	def animation_get_data(self,i):
		...
		print("osc_get_samples showing:",showing,"samples_to_show:",samples_to_show,"tbs:",time_between_samples,"trigger:",trigger_channel,"ets:",self.use_ets.get())
	...
	def on_channel_enabled(self,ch_num):
		try: # On first call, the CHx objects are not yet created
			print("on_channel_enabled ets:",self.use_ets.get(),"ch_num:",ch_num,"ch1:",self.CH1.enabled.get(),"ch2:",self.CH2.enabled.get())
